...
. Copie os diretórios e arquivos do diretório resultante `jdk` (por exemplo, `jdk-11.0.12` para o local onde o Java está instalado. Exemplo: `C:\Program Files\NetApp\JDK\`
